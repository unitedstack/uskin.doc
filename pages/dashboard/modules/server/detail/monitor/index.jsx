...
class Monitor extends React.Component {
  ...
  getMonitorData(chartKey, selectedKey) {
    ...
    switch (chartKey) {
      case 'cpu':
        request.getCPUMonitorData(id, selectedKey).then(res => {
        ...
        break;
      case 'memory':
        request.getMemoryMonitorData(id, selectedKey).then(res => {
          copy.data.forEach((item) => {
            item.data = res.map(resItem => {
              return [
                resItem[0],
        ...
        break;
      case 'bandwidth':
        request.getBandwidthMonitorData(id, selectedKey).then(res => {
        ...
        break;
      case 'packet':
        request.getPacketMonitorData(id, selectedKey).then(res => {
          copy.data.forEach(item => {
            item.data = res[item.key].map(resItem => {
              return [
                resItem[0],
        ...
        break;
      case 'packets_loss':
        request.getPacketLossMonitorData(id, selectedKey).then(res => {
          copy.data.forEach(item => {
            item.data = res[item.key].map(resItem => {
              return [
                resItem[0],
        ...
        break;
      case 'error_packets':
        request.getPacketErrorMonitorData(id, selectedKey).then(res => {
          copy.data.forEach(item => {
            item.data = res[item.key].map(resItem => {
              return [
                resItem[0],
