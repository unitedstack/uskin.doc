...
class ServerStatus extends React.Component {
  ...
  componentDidMount() {
    request.getServerStatus().then(res => {
      this.setState({
        data: res
      });
    });
  ...
  render() {
    ...
    return (
      <div className="server-status-card">
        <div className="server-status-card-left">
          <div className="server-status-card-title">{__.server_status}</div>
        ...
        <div className="server-status-card-right">
          <ul>
            {
