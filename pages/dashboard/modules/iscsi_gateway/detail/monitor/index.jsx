...
class Monitor extends React.Component {
  ...
  getMonitorData(chartKey, selectedKey) {
    ...
    switch (chartKey) {
      ...
      case 'cpu':
        ...
        break;
      case 'received_flow':
        request.getReceivedFlowMonitorData(id, selectedKey).then(res => {
        ...
        break;
      case 'transmit_flow':
        request.getTransmitFlowMonitorData(id, selectedKey).then(res => {
          let unitMax = unit.unitFix(res);
  ...
  render() {
    ...
    return (
      <div className="uds-iscsi-detail-monitor-wrapper">
        <ul>
          {
